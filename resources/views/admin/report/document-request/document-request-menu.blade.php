<div class="py-3">
    ...
    <a href="{{ route('report-docrequest-communion') }}" class="btn btn-success {{ request()->routeIs('report-docrequest-communion') ? 'active' : '' }}">1st Communion</a>
    <a href="{{ route('report-docrequest-matrimony') }}" class="btn btn-success {{ request()->routeIs('report-docrequest-matrimony') ? 'active' : '' }}">Matrimony</a>
