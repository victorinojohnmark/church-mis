...
@section('title', 'Report - Blessing Event Reservation')
            ...
            <div class="card-body">
                <form action="#" class="row" method="POST">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="blessing_type" class="form-control">
    ...
    <table id="blessing-table" class="table table-hover table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{!! $blessing->created_at->format('Y-m-d') !!}</td>
                <td>{!! $blessing->createdBy->name !!}</td>
            </tr>
            @empty
            @endforelse
        </tbody>
...
<a href="{{ route('report-blessinglist') }}" class="btn btn-primary">Refresh List</a>
