<div class="modal fade" id="baptismAcceptModal{{ $baptism->id }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">Accept Baptism Reservation</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
                <form action="{{ route('baptismaccept') }}" method="post">
                    @csrf <input type="hidden" name="id" value="{{ $baptism->id }}">
