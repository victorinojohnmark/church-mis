<button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#deathDocumentRequestModal{{ $deathRequest->id }}">View</button>
<div class="modal fade" id="deathDocumentRequestModal{{ $deathRequest->id ? $deathRequest->id : ''  }}" tabindex="-1" aria-labelledby="documentRequestModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            @include('admin.documentrequest.death.deathform')
        </div>
