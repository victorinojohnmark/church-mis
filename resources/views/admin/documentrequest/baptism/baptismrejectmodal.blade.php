<button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#baptismDocumentRequestRejectModal{{ $baptismRequest->id }}">Reject Request</button>
<div class="modal fade" id="baptismDocumentRequestRejectModal{{ $baptismRequest->id }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form action="{{ route('documentrequestbaptismreject') }}" method="post">
