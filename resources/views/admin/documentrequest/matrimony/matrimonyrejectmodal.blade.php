<button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#matrimonyDocumentRequestRejectModal{{ $matrimonyRequest->id }}">Reject Request</button>
<div class="modal fade" id="matrimonyDocumentRequestRejectModal{{ $matrimonyRequest->id }}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form action="{{ route('documentrequestmatrimonyreject') }}" method="post">
