<div class="col-md-3">
    ...
    <ul id="userSidebar" class="mb-3">
        ...
        <li><a href="{{ route('usernotification') }}" class="py-2 px-3 mb-2 text-dark rounded-pill {{ request()->routeIs('usernotification') ? 'active' : '' }}"><i class="fas fa-bell me-2"></i> Notifications</a></li>
        <li><a href="{{ route('clientreservations') }}" class="py-2 px-3 mb-2 text-dark rounded-pill {{ request()->routeIs('clientreservations') ? 'active' : '' }}"><i class="fas fa-calendar me-2"></i> Reservations</a></li>
