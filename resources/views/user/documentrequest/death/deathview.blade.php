    ...
    <div class="row mt-5">
        ...
        <div class="col-md-9">
            <div id="content" class="px-3">
                ...
                <div class="py-3">
                    <a href="{{ route('client-documentrequestdeathlist') }}" class="btn btn-success btn-sm" >Back to List</a>
                </div>
                <form action="{{ route('client-documentrequestdeathsave', ['deathRequest' => $deathRequest->id]) }}" method="post">
