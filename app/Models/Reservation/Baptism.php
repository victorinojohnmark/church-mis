...
class Baptism extends Model
{
    ...
    protected $fillable = ['name', 'date', 'time', 'sex', 'relationship', 'other_relationship', 'place_of_birth', 'is_special', 'birth_date', 'fathers_name', 'mothers_name', 'present_address', 'contact_number', 'created_by_id'];
