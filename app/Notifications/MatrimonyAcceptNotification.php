...
class MatrimonyAcceptNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ->subject('Matrimony Reservation for '. $this->matrimony->name)
                    ->greeting('Good day '. $this->matrimony->createdBy->name)
                    ->line('Your matrimony reservation for ' . $this->matrimony->name . ' has been accepted.')
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => 'Your matrimony reservation for ' . $this->matrimony->name . ' has been accepted.',
